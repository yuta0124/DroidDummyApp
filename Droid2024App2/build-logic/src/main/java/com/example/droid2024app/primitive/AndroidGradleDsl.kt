...
fun Project.setupAndroid() {
    android {
        ...
        compileOptions {
            ...
            // minSdkVersion的に非対応のJava8の機能を使用する: https://qiita.com/beyondseeker/items/737baaffc7f0635c9e91
            isCoreLibraryDesugaringEnabled = true
        }
        dependencies {
            // isCoreLibraryDesugaringEnabled = trueの場合に必要、ないとエラーになる
            add("coreLibraryDesugaring", libs.library("androidDesugarJdkLibs"))
        }
        testOptions {
            unitTests {
                // ユニットテストでAndroidリソース、アセット、マニフェストを使用できるようにする
...
// detekt設定内容について：https://detekt.dev/docs/gettingstarted/gradle#groovy-dsl-3
